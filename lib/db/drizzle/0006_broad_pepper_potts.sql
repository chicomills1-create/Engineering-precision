ALTER TABLE "client_monthly_email_deliveries" ADD COLUMN "period_key" text;--> statement-breakpoint
...
CREATE UNIQUE INDEX "client_monthly_delivery_email_period_unique" ON "client_monthly_email_deliveries" USING btree (lower(btrim("recipient_email")),"period_key");