ALTER TABLE "growth_referral_partners" ADD COLUMN IF NOT EXISTS "referral_code" text;--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "growth_referral_partners_referral_code_unique" ON "growth_referral_partners" USING btree ("referral_code");
