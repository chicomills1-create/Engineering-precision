...
--> statement-breakpoint
CREATE TABLE "linkedin_content_items" (
...
--> statement-breakpoint
CREATE TABLE "linkedin_approval_events" (
...
--> statement-breakpoint
CREATE TABLE "linkedin_suppressions" (
...
--> statement-breakpoint
CREATE UNIQUE INDEX "linkedin_companies_normalized_name_unique" ON "linkedin_companies" USING btree ("normalized_name");
--> statement-breakpoint
CREATE UNIQUE INDEX "linkedin_companies_domain_unique" ON "linkedin_companies" USING btree ("domain");
--> statement-breakpoint
CREATE UNIQUE INDEX "linkedin_companies_url_unique" ON "linkedin_companies" USING btree ("linkedin_url");
--> statement-breakpoint
CREATE UNIQUE INDEX "linkedin_people_url_unique" ON "linkedin_people" USING btree ("linkedin_url");
--> statement-breakpoint
CREATE UNIQUE INDEX "linkedin_people_company_name_unique" ON "linkedin_people" USING btree ("company_id","normalized_name");
--> statement-breakpoint
CREATE UNIQUE INDEX "linkedin_signals_source_unique" ON "linkedin_signals" USING btree ("source_url");
--> statement-breakpoint
CREATE UNIQUE INDEX "linkedin_suppressions_target_unique" ON "linkedin_suppressions" USING btree ("normalized_target");
--> statement-breakpoint
CREATE INDEX "linkedin_actions_queue_idx" ON "linkedin_actions" USING btree ("status","due_at");
--> statement-breakpoint
CREATE INDEX "linkedin_actions_completed_idx" ON "linkedin_actions" USING btree ("completed_at");
--> statement-breakpoint
CREATE INDEX "linkedin_actions_person_idx" ON "linkedin_actions" USING btree ("person_id","status");
--> statement-breakpoint
CREATE INDEX "linkedin_actions_campaign_idx" ON "linkedin_actions" USING btree ("campaign_id","status");
--> statement-breakpoint
CREATE INDEX "linkedin_people_retention_idx" ON "linkedin_people" USING btree ("retention_until");
--> statement-breakpoint
CREATE INDEX "linkedin_people_status_idx" ON "linkedin_people" USING btree ("status");
--> statement-breakpoint
CREATE INDEX "linkedin_signals_queue_idx" ON "linkedin_signals" USING btree ("status","observed_at");
--> statement-breakpoint
CREATE INDEX "linkedin_signals_person_idx" ON "linkedin_signals" USING btree ("person_id");
--> statement-breakpoint
CREATE INDEX "linkedin_signals_company_idx" ON "linkedin_signals" USING btree ("company_id");
--> statement-breakpoint
CREATE INDEX "linkedin_campaigns_status_idx" ON "linkedin_campaigns" USING btree ("status");
--> statement-breakpoint
CREATE INDEX "linkedin_content_queue_idx" ON "linkedin_content_items" USING btree ("status","scheduled_for");
--> statement-breakpoint
CREATE INDEX "linkedin_approval_events_action_idx" ON "linkedin_approval_events" USING btree ("action_id","created_at");
--> statement-breakpoint
CREATE INDEX "linkedin_outcomes_attribution_idx" ON "linkedin_outcomes" USING btree ("campaign_id","outcome_type","occurred_at");
--> statement-breakpoint
CREATE INDEX "linkedin_outcomes_action_idx" ON "linkedin_outcomes" USING btree ("action_id","occurred_at");