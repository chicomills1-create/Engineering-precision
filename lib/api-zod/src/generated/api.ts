...
export const GenerateOutreachDraftResponseItem = zod.object({
  ...
  "error": zod.string().nullish(),
  "sourceType": zod.union([zod.literal('lead'),zod.literal('referral_partner'),zod.literal('public_opportunity'),zod.literal('hot_lead'),zod.literal('hot_lead_verified'),zod.literal('hot_market_one_time'),zod.literal('hot_market_verified_national'),zod.literal(null)]).nullish(),
