...
Maintain three ordered library lanes: Personal, Public, and Hot Market. Personal holds named contacts obtained through one paid lookup after public qualification; Public holds company-published emails found without finder credits. Hot Market primarily targets builders, general contractors, and construction companies actively building in a target location or growth market, plus qualified architecture/design referral partners serving that activity.
...
National Hot Market replenishment must prefer zero-credit public evidence and accept honest shortfalls. Hot Market means any U.S. market with strong current opportunity signals. Its core company groups are active commercial builders, major and local contractors, production and luxury/custom-home builders, and construction companies working in specific active locations or growth markets. It also includes architecture/design referral partners with substantial active portfolios and builder/owner collaboration. Every record still requires a named relevant role and a visibly published company-domain email before automatic approval. See [Hot Market definition](hot-market-definition.md) for the canonical lanes and representative firms.
...
**How to apply:** Search nationally for the strongest current market signals while respecting Apex Grid's service and licensing constraints. Lead with companies actively building commercial, residential, infrastructure, production, or custom/luxury work in those locations. Add architecture/design firms when their portfolios indicate recurring engineering coordination opportunities. Keep the direct-client builder email and relationship-focused architecture/referral email separate, skip incomplete or duplicate records, and leave unused slots empty rather than lowering contact-evidence requirements.
