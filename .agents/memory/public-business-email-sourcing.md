...
**Why:** The outreach cohort must continue growing when one enrichment provider reaches a quota. Rejecting public company addresses solely because they did not come from a finder API unnecessarily blocks legitimate contacts.

**How to apply:** Run company discovery, public email discovery, verification, and deduplication as separate stages. Search official websites and documents first, then reliable public directories and indexed documents, then enrichment. Never infer addresses from naming patterns. Skip unresolved companies and continue to new businesses until the completed cohort reaches 2,027.