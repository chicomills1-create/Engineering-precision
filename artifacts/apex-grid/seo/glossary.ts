...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
...

  {
    ...
    extended: "Licensure is state-specific — a PE licensed in Arizona must obtain a separate license to practice in California, though most states participate in comity agreements that streamline the process. Apex Grid holds PE licenses in 49 states, enabling the firm to stamp and seal drawings for projects nationwide without requiring the client to find state-specific engineers. The PE's stamp on a set of drawings is a legal representation that the engineer has reviewed the design and accepts professional responsibility for it. Unlicensed persons cannot legally perform or represent engineering services in most states.",
