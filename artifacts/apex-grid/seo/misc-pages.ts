...
export const MISC_PAGES: MiscPage[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "SAM.gov entity registration, UEI, and CAGE information must be confirmed in the official entity record",
          ...
          "Remote project coordination may be available where the responsible professional's license, firm authorization, discipline, and AHJ requirements are verified",
        ],
      },
      {
  ...
  },
  {
    ...
    title: "Government Contracting Engineering | Apex Grid Engineering",
    description: "Apex Grid Engineering provides multi-discipline support for government projects. Professional credentials and procurement classifications are confirmed from current official records for each pursuit.",
    h1: "Government Engineering and Federal Contracting",
    kicker: "Government Contracting",
    lede: "Apex Grid Engineering provides engineering support to federal agencies, military installations, and government contractors. Current professional credentials, SAM.gov entity information, SBA VetCert status, size status, and solicitation-specific eligibility must be confirmed from official records before a pursuit relies on them.",
    sections: [
      {
        heading: "Federal Registration and Certification Verification",
        content: "Apex Grid Engineering is led by a Service-Disabled Veteran — Jeremy Mills, founder and CEO, USAF disabled veteran — and may pursue applicable federal opportunities only after current SBA certification and solicitation requirements are verified.",
        bullets: [
          "Veteran ownership is business-provided; current SBA VetCert status must be confirmed",
          "Confirm current SAM.gov entity information, UEI, and CAGE information in the official entity record",
          "Confirm current SBA VetCert certification before relying on a veteran-owned designation",
          "Confirm solicitation-specific set-aside eligibility with the contracting authority",
      ...
      },
      {
        ...
        bullets: [
          "Official registration and certification records should be checked directly before procurement use",
  ...
  },
  {
    ...
    kicker: "Quality",
    lede: "Engineering quality control is intended to catch errors before they reach the building department or the field. Apex Grid defines a project-specific review plan based on scope, discipline, jurisdiction, and the responsible professional's requirements.",
    sections: [
      {
        ...
        bullets: [
          ...
          "First-cycle permit approval is the standard we engineer to",
           "Coordination review can help prevent field RFIs and costly changes",
          "Professional liability is protected by rigorous internal review",
        ],
      },
      {
        heading: "Our QA/QC Process",
        content: "The QA/QC workflow is set for each project according to its size, regulated scope, discipline, jurisdiction, and responsible professional.",
        bullets: [
          "Independent calculation review when required by the project QA/QC plan",
          ...
          "Responsible-professional review and seal only after current individual license, firm authorization, discipline, and AHJ requirements are verified",
          "Final package review for organization and formatting",
        ],
      },
      {
        heading: "Professional Engineering Standards",
        content: "For regulated engineering, Apex Grid confirms the responsible professional's current jurisdictional license, applicable firm authorization, discipline, and AHJ requirements before accepting the scope.",
        bullets: [
          "Seal and signature requirements confirmed for the project jurisdiction and discipline",
  ...
  },
  {
    ...
    kicker: "Professional Engineering",
     lede: "Professional engineering is a licensed profession. The responsible engineer must meet the applicable board requirements and hold current authorization for the project jurisdiction and discipline before signing or sealing documents. For Apex Grid work, the responsible individual license, firm authorization, discipline, and AHJ requirements are verified for each project.",
    sections: [
      {
        ...
        bullets: [
          ...
          "Passing the Principles and Practice of Engineering (PE) exam in the relevant discipline",
           "Current authorization from the applicable state board for the project jurisdiction",
          "Continuing education to maintain active licensure",
           "Signing and sealing authority depends on the applicable board rules, project discipline, and AHJ requirements",
        ],
      },
      {
        ...
        bullets: [
          ...
          "The PE accepts professional liability for the stamped work",
           "Some building departments require a seal from an appropriately authorized professional as part of permit review",
           "The responsible professional's current license and authorization must be verified for the project jurisdiction",
          "Stamping work the PE did not directly supervise is an ethics violation",
           "Any Apex Grid seal is issued only after the responsible individual's license, firm authorization, discipline, and AHJ requirements are verified",
        ],
      },
      {
        heading: "Apex Grid's Licensed Engineers",
         content: "Apex Grid Engineering evaluates each requested discipline and jurisdiction before accepting work. Current board evidence for the responsible individual, firm authorization, discipline, and AHJ requirements must be verified for the specific project.",
        bullets: [
           "Structural, mechanical, electrical, civil, plumbing, and geotechnical scopes are evaluated separately",
           "Responsible professional license and discipline are verified against current board records",
           "Firm authorization and authority-having-jurisdiction requirements are confirmed before accepting the work",
        ],
      },
      {
        ...
        bullets: [
          ...
          "Engineers report known violations of engineering safety",
           "Responsible charge and any seal or stamp are addressed in the project scope; no professional should sign work outside the applicable rules",
        ],
      },
      {
        ...
        bullets: [
          "PE-stamped drawings from engineers who actually did the engineering",
           "Responsible charge is documented where required — the signing professional's involvement is confirmed for the project",
