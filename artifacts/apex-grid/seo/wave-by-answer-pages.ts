  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Redundant power with generator backup, redundant communications paths, and HVAC that keeps operations spaces functional through utility failures. The headquarters is the last building that should go dark — I engineer its resilience accordingly.",
      },
    ],
    sections: [
      {
