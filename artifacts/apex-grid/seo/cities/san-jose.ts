...
export const sanJose: CityData = {
  ...
  codes: {
    building: "2025 California Building Standards Code (Title 24), effective January 1, 2026, with San José local amendments",
    energy: "2025 California Energy Code (Title 24, Part 6), effective January 1, 2026, with any applicable San José reach-code provisions",
    amendments:
      "San José adopts local amendments to the California codes and publishes project-specific building-code and reach-code requirements. Whether a reach-code or electrification provision applies depends on the current municipal code, permit cycle, occupancy, and scope, so the City's current code page controls rather than an older checklist.",
  },
  utilities: {
  ...
  narratives: {
    ...
    energy:
      "Energy compliance in San José begins with the California Energy Code, Title 24 Part 6, and then tests the current San José Building Reach Code or other local provisions for the project's scope. Efficient all-electric HVAC, heat-pump water heating where applicable, envelope and glazing performance, lighting controls, and solar/load-management decisions must be modeled as a coordinated system. In a warm, dry climate, reducing solar gains and managing cooling peaks can be as consequential as nominal equipment efficiency. PG&E service and interconnection coordination belongs beside the Title 24 documentation, particularly where electrification shifts a project onto a larger service.",
  },
  faqs: [
    {
      q: "Which building and energy codes apply in San José?",
      a: "San José enforces the California Building Standards Code (Title 24) with local amendments. Commercial energy work follows Title 24 Part 6, and the current City Building Reach Code or other local provisions must be checked for the project's scope.",
    },
    {
    ...
    },
    {
      ...
      a: "Bay Area seismic design is central, with active-fault, liquefaction, lateral-spreading, groundwater, and fill conditions varying significantly by location. A site-specific geotechnical report should inform the California Building Standards Code seismic analysis, foundation design, and any excavation or shoring strategy.",
    },
  ],
  research: {
    ...
    sources: {
      ...
      utilities: ["https://www.sanjoseca.gov/your-government/departments-offices/energy", "https://www.sanjoseca.gov/your-government/departments-offices/environmental-services/water-utilities", "https://www.pge.com/"],
      climate: ["https://www.weather.gov/mtr/", "https://myhazards.caloes.ca.gov/"],
      market: ["https://www.sanjoseca.gov/business-development", "https://www.sanjoseca.gov/your-government/departments-offices/economic-development"],
    },
  },
};