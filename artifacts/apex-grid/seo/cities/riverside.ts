...
export const riverside: CityData = {
  ...
  codes: {
    building: "2022 Riverside Building Code, based on the 2022 California Building Code (2021 IBC) with City of Riverside amendments",
    energy: "2022 California Energy Code (Title 24, Part 6), with 2022 CALGreen mandatory measures",
    amendments:
      "Riverside Municipal Code Title 16 adopts the California code family with local amendments. Fire, grading, stormwater, water-efficient landscape, and wildland-urban-interface requirements can add site- and location-specific obligations beyond the base California Building Code.",
  },
  utilities: {
  ...
  climateNotes:
    "Riverside's inland Southern California setting is hot and dry (generally ASHRAE 3B/California climate zone 10), with sustained summer heat, Santa Ana wind events, drought, and episodic wildfire smoke. The city is in a high-seismic region; alluvial soils, liquefaction potential near waterways, and flood hazards require parcel-specific study.",
  marketNotes:
