...
export const stockton: CityData = {
  ...
  codes: {
    building: "2025 California Building Standards Code (Title 24), including the 2025 California Building Code (Title 24, Part 2), effective January 1, 2026, with City of Stockton amendments where applicable",
    energy: "2025 California Energy Code (Title 24, Part 6), effective January 1, 2026, with applicable City amendments and CALGreen measures; no separate Stockton reach provision is asserted here",
    amendments:
      "Stockton's Building & Life Safety and Planning & Engineering pages identify the City's local development review requirements; applicable municipal amendments must be confirmed for the address and scope. City floodplain, grading, stormwater, fire, zoning, and public-works provisions apply alongside Title 24; Delta-adjacent and redevelopment sites require parcel-specific utility and flood screening.",
  },
  utilities: {
  ...
  narratives: {
    mep:
      "Stockton MEP design addresses hot Central Valley cooling peaks, winter fog and damp conditions, and wildfire-smoke events that can limit outdoor-air strategies. Logistics, cold storage, food processing, port-adjacent operations, and healthcare programs need load, refrigeration, ventilation, and resilience assumptions developed from the operating plan. PG&E service capacity and interconnection are early electrical constraints, while City Municipal Utilities connections affect domestic, fire, process, sewer, and drainage coordination. The currently adopted Title 24 baseline is applied with real schedules and control sequences rather than a generic warehouse or office profile.",
    structural:
      "Stockton projects follow the locally adopted CBC seismic provisions, but foundation and lateral design depend strongly on Delta and Central Valley soil conditions. Alluvial deposits, high groundwater, settlement, subsidence, and liquefaction potential can drive the geotechnical recommendations for foundations, slabs, pavements, and underground utilities. Large logistics roofs also require attention to seismic diaphragm and collector behavior, wind, drift, and rooftop-equipment anchorage. City review and special inspections are coordinated with the structural package, especially where industrial occupancy or racking introduces substantial concentrated loads.",
    civil:
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "For permits subject to the current cycle, Stockton applies the 2025 California Building Standards Code, including the 2025 California Building Code, effective January 1, 2026, with local amendments where applicable. Commercial energy compliance uses the 2025 California Energy Code, Title 24 Part 6, plus applicable CALGreen measures; local floodplain, grading, stormwater, and public-works requirements also apply.",
    },
    {
  ...
  research: {
    ...
    sources: {
      ahj: ["https://www.stocktonca.gov/business/building___life_safety/building_permits____inspections.php"],
      ...
      amendments: ["https://www.stocktonca.gov/business/planning___engineering/index.php"],
      utilities: ["https://www.stocktonca.gov/services/water,_sewer___stormwater/capplications,_forms___permits.php", "https://www.pge.com/en/business-resources.html"],
      climate: ["https://www.weather.gov/sto/"],
      market: ["https://www.stocktonca.gov/business/economic_development/index.php"],
    },
  },
};