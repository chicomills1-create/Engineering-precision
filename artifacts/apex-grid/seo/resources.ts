...
<p>Title 24 is the California Code of Regulations governing building standards. Part 6 covers energy efficiency for both residential and nonresidential buildings. The California Energy Commission (CEC) updates the standards on an approximately three-year cycle. The 2025 Standards (effective January 1, 2026) are currently enforced. They build on the 2022 Standards' expanded requirements for solar-ready construction, heat pump readiness, and EV charging infrastructure.</p>
...
<h3>HVAC</h3>
<p>Equipment efficiency (EER, COP, IEER) must meet minimum values. Controls including economizers, demand-controlled ventilation (DCV), and setback thermostats are often required. The 2025 Standards continue the push toward heat pump technology and refrigerant transition.</p>
