      ...
      <section className="py-20 bg-card border-b border-border">
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-px bg-border rounded-sm overflow-hidden mb-8">
            ...
            >
              Submitting an RFP or RFQ? Send it here <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
        </div>
      </section>
