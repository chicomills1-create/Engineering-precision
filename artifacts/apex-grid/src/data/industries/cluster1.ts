...
export const CLUSTER1_INDUSTRIES: Industry[] = [
  ...
  },
  {
    ...
    intro: [
      ...
      "Apex Grid provides integrated structural, MEP, civil, and geotechnical engineering for civic and municipal clients, from city halls and courthouses to police, fire, and emergency-operations facilities. We design essential public-safety buildings to Risk Category IV, add security hardening and blast resilience where the threat assessment requires it, and meet the energy codes and sustainability targets public agencies mandate. Licensed in 49 states, we deliver permit-ready documents and the specifications public bidding requires.",
    ],
    specialties: [
      {
