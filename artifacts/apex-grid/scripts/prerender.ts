...
const routeMeta: Record<string, [string, string]> = {
  ...
  "/procurement/submit-rfp-rfq/": ["Submit an RFP or RFQ Package | Apex Grid Engineering", "Prime contractors and procurement teams can securely submit active RFP or RFQ packages, project requirements, and supporting files for engineering review."],
