import qualified from "../../../../.agents/outputs/sep02-qualified-preverify.json";
...
export const VERIFIED_OUTREACH_CONTACTS_SEP_02 = (qualified as RawContact[])
  .map((raw) => ({
    dedupeKey: `verified-2026-09-02-${slug(raw.companyName)}-${slug(raw.contactName)}`,
