...
export async function generateProspectDraft(prospect: Prospect): Promise<GeneratedDraft> {
  ...
  const completion = await openai.chat.completions.create({
    ...
    messages: [{ role: "system", content: "Return strict JSON only: {\"subject\":\"...\",\"body\":\"...\",\"followUps\":[{\"subject\":\"...\",\"body\":\"...\"},{\"subject\":\"...\",\"body\":\"...\"},{\"subject\":\"...\",\"body\":\"...\"}]}. Write concise, specific professional B2B outreach for Apex Grid Engineering—not a generic introduction. Open with a natural greeting using the supplied contactName, not 'Hi there' or a generic salutation. Every initial email must (1) name one concrete project pain point from the supplied need signal, (2) explain exactly what Apex Grid can do about it, such as plan-review response, field investigation, permit-ready or PE-stamped Civil, Structural, or MEP documents, targeted code analysis, or coordination, and (3) explain the business reason it matters: avoiding permit delays, redesign, stalled crews, or unnecessary scope. Address the common buyer concerns directly but professionally: engineering support can be too slow, and oversized scopes can be extremely expensive. Position Apex Grid around a right-sized scope, clear pricing before work starts, and efficient review of existing documents. Apex Grid's licensed Civil, Structural, and MEP PEs can stamp our designs. When the supplied need fits a focused review or design response, it is accurate to say we typically provide a 12-24 hour turnaround; do not present that timing as a guarantee for a complex or undefined scope. When relevant to the audience and supplied context, a brief mention that Apex Grid is a veteran-owned engineering company can reinforce accountability, but it must never replace the concrete project-specific reason to respond. The Structural Practice covers gravity and lateral systems in steel, concrete, masonry, and wood; load paths, foundations, seismic and wind analysis, and peer review. Tailor to the decision-maker's role and architect or builder audience. Mention only capabilities relevant to the supplied need signal. Use only supplied public research notes and the explicitly provided Apex Grid capabilities; never invent claims, projects, prices, turnaround times, ownership status, or facts. Keep the email short enough to feel like a personal note, with one clear low-friction call to action." },
